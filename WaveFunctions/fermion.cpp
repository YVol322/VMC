...
int Fermion::BetaIndex(int i, int j)
{
...
double Fermion::a_ij(int i, int j)
{
    int n_particles = m_particles;
...
double Fermion::r_squared(std::vector<std::unique_ptr<class Particle>>& particles, int part_idx)
{
    Particle& particle_i = *(particles[part_idx]);
