...
SlaterDeterminant::SlaterDeterminant(double alpha)
{
    assert(alpha >= 0);
...
double SlaterDeterminant::Psi1(std::vector<std::unique_ptr<class Particle>>& particles, double part_inx)
{
...
double SlaterDeterminant::Psi2(std::vector<std::unique_ptr<class Particle>>& particles, double part_inx)
{
    Particle particle_i = *(particles.at(part_inx));
...
double SlaterDeterminant::Psi3(std::vector<std::unique_ptr<class Particle>>& particles, double part_inx)
{
    Particle particle_i = *(particles.at(part_inx));
...
double SlaterDeterminant::Psi1DoubleDer(std::vector<std::unique_ptr<class Particle>>& particles, double part_inx)
{
    double alpha = m_parameters.back();
    Particle particle_i = *(particles.at(part_inx));
...
double SlaterDeterminant::Psi2DoubleDer(std::vector<std::unique_ptr<class Particle>>& particles, double part_inx)
{
    double alpha = m_parameters.back();
    Particle particle_i = *(particles.at(part_inx));
...
double SlaterDeterminant::Psi3DoubleDer(std::vector<std::unique_ptr<class Particle>>& particles, double part_inx)
{
    double alpha = m_parameters.back();
    Particle particle_i = *(particles.at(part_inx));
...
double SlaterDeterminant::SD(std::vector<std::unique_ptr<class Particle>>& particles, double row_indx, double parts)
{
...
double SlaterDeterminant::r_squared(std::vector<std::unique_ptr<class Particle>>& particles, int part_index)
{
...
double SlaterDeterminant::evaluate(std::vector<std::unique_ptr<class Particle>>& particles)
{   
...
double SlaterDeterminant::computeDoubleDerivative(std::vector<std::unique_ptr<class Particle>>& particles)
{
    double laplacian1 = 0;
    double laplacian2 = 0;
    for (int i = 0; i < 3 ; i++)
