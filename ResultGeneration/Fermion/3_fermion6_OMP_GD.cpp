...
int main() {
	...
	std::vector<double> stepLength_arr = {1e-1, 1e-2, 1e-3};
	std::vector<double> learning_rate_arr = {1e-1, 1e-2, 1e-3};
    ...
    std::string path = "Results/Tables/Fermions/Interacting/Program3";
